...
#nullable restore
            ...
            /// <summary>Name of the page to retrieve. Value can be `first`, `last`, `next`, or `previous`. Defaults to `first`.</summary>
            [QueryParameter("page")]
            public global::Soenneker.Mailgun.OpenApiClient.V3.Item.Templates.GetPageQueryParameterType? PageAsGetPageQueryParameterType { get; set; }
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TemplatesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Mailgun.OpenApiClient.V3.Item.Templates.TemplatesRequestBuilder.TemplatesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
