...
{
    /// <summary>
    /// Builds and executes requests for operations under \v3\{domainName-id}\templates
    /// </summary>
    ...
    public partial class TemplatesRequestBuilder : BaseRequestBuilder
    {
        ...
        public TemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v3/{domainName%2Did}/templates{?limit*,p*,page*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Mailgun.OpenApiClient.V3.Item.Templates.TemplatesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TemplatesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v3/{domainName%2Did}/templates{?limit*,p*,page*}", rawUrl)
        {
        }
        /// <summary>
