...
{
    /// <summary>
    /// Builds and executes requests for operations under \v3\{domainName}\bounces\{address}
    /// </summary>
    ...
    public partial class WithAddressItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithAddressItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v3/{domainName}/bounces/{address}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Mailgun.OpenApiClient.V3.Item.Bounces.Item.WithAddressItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithAddressItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v3/{domainName}/bounces/{address}", rawUrl)
        {
        }
        /// <summary>
